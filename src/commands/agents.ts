...
export const commandAgents = Command.make("agents").pipe(
  Command.withDescription(
    "Manage agent presets used to run tasks. Use 'ls' to inspect presets and 'add'/'edit' to configure the CLI agent, AI provider/model, arguments, and any issue-source options.",
  ),
  Command.withAlias("a"),
  subcommands,
)
